...
ROOT_URLCONF = 'weather.weather.urls'

TEMPLATES = [
    {
        'BACKEND': 'django.template.backends.django.DjangoTemplates',
        'DIRS': [
            BASE_DIR / 'templates',  # корневая папка templates
        ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
WSGI_APPLICATION = 'weather.weather.wsgi.application'
ASGI_APPLICATION = 'weather.weather.asgi.application'
...
OPENWEATHERMAP_SECRET_KEY=env('OPENWEATHERMAP_SECRET_KEY')
